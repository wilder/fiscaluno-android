...
class IntroActivity : AppIntro() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addSlide(AppIntroFragment.newInstance("Encontre as melhores faculdades de uma categoria", "Avaliamos segurança, infraestrutura, corpo docente, comunicação etc", R.mipmap.ic_launcher,resources.getColor(R.color.colorAccent)))
